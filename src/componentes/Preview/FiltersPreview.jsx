...
import NumberLanguage from "./Filters/NumberLanguage";
import TimePeriodPreview from "./Filters/TimePeriodPreview";
import PlaytimePreview from "./Filters/PlaytimePreview";
...
const FiltersPreview = () => {
  ...
  const handleSubmit = () => {
    ...
    navigate(`/preview-reviews/${appId}?${query}`);
  };
    ...
    <div className="">
      ...
      <div className="font-sf flex justify-center align-center">
        <div>
          ...
          <div className="outline-none mt-6 ml-10 mr-10 mb-6 card-filters flex">
          ...
          <div className="justify-center flex mt-5 mr-10 ml-10">
